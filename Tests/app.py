...
REPORTS_DIR = r'test_reports'
is_running = False
running_tests_process = None
os.makedirs(REPORTS_DIR, exist_ok=True)

tests = [
    {"name": "test_ActionByUserRole", "path": "test_ActionByUserRole.py"},
    {"name": "test_AddBeneficiaries", "path": "test_AddBeneficiaries.py"},
    {"name": "test_AddMoney", "path": "test_AddMoney.py"},
    {"name": "test_AddPayment", "path": "test_AddPayment.py"},
    {"name": "test_AddPaymentFromDeshboard", "path": "test_AddPaymentFromDeshboard.py"},
    {"name": "test_ConvertFromDashboard", "path": "test_ConvertFromDashboard.py"},
    {"name": "test_hit", "path": "test_hit.py"},
    {"name": "test_mass_our_type_cost", "path": "test_mass_our_type_cost.py"},
    {"name": "test_mass_payment", "path": "test_mass_payment.py"},
    {"name": "max", "path": "../Tests"},  # Points to the parent 'Tests' directory
    {"name": "test_payment_our_fee", "path": "test_payment_our_fee.py"},
    {"name": "test_TravelCash", "path": "test_TravelCash.py"},
    {"name": "test_Edit_beneficiary", "path": "test_Edit_beneficiary.py"},
    {"name": "test_LockUpFromDashboard", "path": "test_LockUpFromDashboard.py"},
    {"name": "api", "path": "../Okoora_Api"},  # Points to 'Okoora_Api' directory one level up
    {"name": "run_full_regression", "path": "../Tests"}  # Points to the parent 'Tests' directory
]
        ...
        if test_name == "test_ActionByUserRole":
            ...
            if os.path.exists(report_file):
                try:
                    ...
                    return jsonify(success=False, output=result.stdout, error=f"JSON decode error: {str(e)}")
            else:
                return jsonify(success=False, output=result.stdout, error="Report file not found")
